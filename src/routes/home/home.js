    ...
    return (
      <div className="home">
        ...
        <section className="process container">
          ...
          <h3>How it Works</h3>
          <p>
            Each shelter's adoption process is different. Here's an example of
            how a shelter adoption might work:
          </p>
          <ol>
            <li>
            ...
            <li>
              You click <strong>Adopt</strong> and fill in your name. This gets
              sent to the shelter so they can get ready for you.
            </li>
            <li>
